...
const documentData = z.object({
    type:                       z.nullable(z.string()).describe(`Tipo do documento roubado, como por exemplo rg, cnh, passaporte ou outro.`),
...
const objectData = z.object({
    ...
    description:    z.nullable(z.string()).describe(`Descricao do objeto roubado.`),
...
const theftDataExtractionAgent = chatGPTModel.withStructuredOutput(theftDataSchema)
